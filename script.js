...
if(quoteForm){
  quoteForm.addEventListener('submit', function(e){
    ...
    fetch('/', {
      ...
      formStatus.textContent = "Thanks, we've got your request and will be in touch soon.";
      formStatus.classList.add('success');
      quoteForm.reset();
    }).catch(() => {
      formStatus.textContent = "Something went wrong. Please call us instead at (256) 415-6503.";
